          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <img src="/illustrations/brain-networks.svg" alt={labels.imgAlt} className="rounded-lg shadow-lg w-full" />
