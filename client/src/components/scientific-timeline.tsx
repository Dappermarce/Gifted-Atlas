...
export default function ScientificTimeline() {
  ...
  const milestones = lang === 'es'
    ? [
        { year: "1869", title: "El genio hereditario", author: "Francis Galton", significance: "Investigación histórica temprana sobre diferencias individuales", impact: "Influyó en la psicología diferencial y también dejó sesgos que deben examinarse", type: "fundamentos", details: "Galton estudió familias prominentes e interpretó sus patrones como hereditarios. Sus métodos no podían separar herencia, privilegio y oportunidades, y su proyecto estuvo ligado a la eugenesia." },
        { year: "1905", title: "Prueba de inteligencia Binet–Simon", author: "Alfred Binet & Théodore Simon", significance: "Primera medición cuantitativa de inteligencia", impact: "Nacimiento de la psicometría moderna", type: "avance", details: "Comparó la edad mental con la edad cronológica y sentó una base histórica para el CI moderno." },
        { year: "1916", title: "Escala de Inteligencia Stanford–Binet", author: "Lewis Terman", significance: "Adaptación y estandarización estadounidense del Binet–Simon", impact: "Consolidación histórica del CI como puntuación estandarizada", type: "medición", details: "Terman revisó tareas, normas y procedimientos para el contexto estadounidense. El instrumento fue influyente, pero sus usos históricos también reflejaron sesgos culturales y sociales." },
        { year: "1921-1956", title: "Estudios genéticos del genio", author: "Lewis Terman", significance: "Estudio longitudinal temprano de estudiantes con CI alto", impact: "Datos históricos sobre trayectorias académicas y vitales", type: "estudio longitudinal", details: "Siguió a 1.528 participantes seleccionados con criterios propios de su época. Fue influyente, pero su muestra y procedimientos limitan la generalización y reflejan sesgos históricos." },
        { year: "1926-1942", title: "Niños superdotados y niños con CI superior a 180", author: "Leta Hollingworth", significance: "Trabajo pionero en educación y desarrollo de estudiantes con puntuaciones muy altas", impact: "Mayor atención a necesidades educativas y ajuste social", type: "fundamentos", details: "Hollingworth estudió a niños con puntuaciones de CI excepcionalmente altas y cuestionó explicaciones de género de su época. Sus muestras fueron pequeñas y deben leerse en su contexto histórico." },
        { year: "1950", title: "Modelo de la estructura del intelecto", author: "J.P. Guilford", significance: "Modelo multifactorial de inteligencia", impact: "Diversificación del concepto de superdotación", type: "teoría", details: "Propuso 120 factores cognitivos, incorporó la creatividad como componente clave y distinguió entre pensamiento convergente y divergente." },
        { year: "1971", title: "Estudio de Jóvenes Matemáticamente Precoces", author: "Julian Stanley", significance: "Identificación temprana de talento matemático", impact: "Programas de aceleración académica", type: "programa", details: "Aplicó la sección matemática del SAT desde los 12 años y mantuvo un seguimiento durante más de 50 años." },
        { year: "1978", title: "Modelo de los Tres Anillos", author: "Joseph Renzulli", significance: "La superdotación como intersección de tres rasgos", impact: "Redefinición práctica del superdotado en el aula", type: "modelo", details: "Alta capacidad + Creatividad + Compromiso con la tarea. Fundamentó políticas educativas en EE.UU. y Europa. Distinción entre 'superdotado escolar' y 'superdotado productivo-creativo'." },
        { year: "1983", title: "Estructuras de la mente: teoría de las inteligencias múltiples", author: "Howard Gardner", significance: "Propuesta de capacidades relativamente diferenciadas", impact: "Gran influencia educativa y debate psicométrico persistente", type: "modelo", details: "Gardner propuso varias inteligencias —entre ellas lingüística, lógico-matemática, musical y espacial—. Es un marco influyente, pero su condición como teoría psicométrica de inteligencias independientes sigue discutida." },
        { year: "1985", title: "Teoría triárquica de la inteligencia", author: "Robert Sternberg", significance: "Inteligencia analítica, creativa y práctica", impact: "Evaluación multidimensional del talento", type: "teoría", details: "Componentes, experiencia y contexto. Inteligencia exitosa. Sternberg amplió el modelo a la 'teoría WICS' (sabiduría, inteligencia, creatividad y síntesis)." },
        { year: "1993", title: "Modelo diferenciado de dotación y talento", author: "Françoys Gagné", significance: "Distinción entre dotación y talento", impact: "Marco conceptual para desarrollo del talento", type: "modelo", details: "Incluye catalizadores intrapersonales y ambientales; su versión revisada se conoce como DMGT 2.0." },
        { year: "2007", title: "Teoría de integración parietofrontal", author: "Jung & Haier", significance: "Modelo neurocognitivo de la inteligencia", impact: "Hipótesis de integración entre regiones parietales y frontales", type: "neurociencia", details: "El modelo P-FIT se basa en la convergencia de estudios de neuroimagen; describe tendencias grupales y no identifica altas capacidades a nivel individual." },
      ]
    : [
