...
type Copy = { name: string; subtitle: string; function: string; example: string; limit: string };
type Region = { id: RegionId; view: View; color: string; point: [number, number]; path: string; es: Copy; en: Copy };
...
const REGIONS: Region[] = [
  { id: "frontal", view: "surface", color: "#af8fe9", point: [200, 170], path: "M65 265 L65 110 L180 42 L300 36 C302 74 279 104 280 136 C266 158 275 178 259 192 C253 213 247 230 226 244 L163 269 L100 287 Z",
    es: { name: "Lóbulo frontal", subtitle: "Sostener una intención", function: "Participa en planificar, resolver problemas y regular acciones junto con otras áreas.", example: "Mantener un objetivo mientras comparas distintas maneras de resolver una tarea.", limit: "No es un centro aislado del talento: su actividad depende de la tarea y de su interacción con otras regiones." },
    en: { name: "Frontal lobe", subtitle: "Holding an intention", function: "Contributes to planning, problem-solving and regulating actions alongside other areas.", example: "Keeping a goal in mind while comparing different ways to solve a task.", limit: "It is not an isolated talent center: its activity depends on the task and on interactions with other regions." } },
  { id: "parietal", view: "surface", color: "#887dd9", point: [370, 145], path: "M300 36 L425 36 L470 93 C451 114 460 145 441 172 C433 190 421 208 404 219 C370 218 345 228 314 229 L226 244 C247 230 253 213 259 192 C275 178 266 158 280 136 C279 104 302 74 300 36 Z",
    es: { name: "Lóbulo parietal", subtitle: "Relacionar lo que percibimos", function: "Integra información sensorial y participa en la orientación espacial y la atención.", example: "Situar las piezas de un problema espacial y relacionarlas entre sí.", limit: "Una asociación entre una región y una tarea no significa que esa región trabaje sola ni que permita identificar altas capacidades." },
    en: { name: "Parietal lobe", subtitle: "Connecting what we perceive", function: "Integrates sensory information and contributes to spatial orientation and attention.", example: "Locating the pieces of a spatial problem and relating them to one another.", limit: "An association between a region and a task does not mean that it works alone or that it can identify giftedness." } },
  { id: "temporal", view: "surface", color: "#bb80b8", point: [298, 291], path: "M163 269 C190 262 207 254 226 244 C261 242 282 225 314 229 C345 228 370 218 404 219 C422 243 421 278 413 320 L365 366 L259 368 L176 325 Z",
    es: { name: "Lóbulo temporal", subtitle: "Dar contexto a sonidos y recuerdos", function: "Interviene en procesar sonidos; distintas áreas temporales también participan en lenguaje y memoria.", example: "Reconocer una voz y conectar lo que escuchas con lo que ya conoces.", limit: "La memoria y el lenguaje están distribuidos. Esta división por lóbulos sirve para orientarse, no para resumir todas sus redes." },
    en: { name: "Temporal lobe", subtitle: "Giving sounds and memories context", function: "Processes sounds; different temporal areas also contribute to language and memory.", example: "Recognizing a voice and connecting what you hear with what you already know.", limit: "Memory and language are distributed. Dividing the brain into lobes helps orientation but does not capture all their networks." } },
  { id: "occipital", view: "surface", color: "#777fc7", point: [498, 216], path: "M470 93 L574 116 L574 277 L496 323 L413 320 C421 278 422 243 404 219 C421 208 433 190 441 172 C460 145 451 114 470 93 Z",
    es: { name: "Lóbulo occipital", subtitle: "Construir la experiencia visual", function: "Procesa información visual en colaboración con circuitos que continúan hacia otras regiones.", example: "Distinguir bordes y formas antes de reconocer un objeto.", limit: "Ver no es una operación única. El reconocimiento, la atención y la interpretación requieren más que la corteza occipital." },
    en: { name: "Occipital lobe", subtitle: "Building visual experience", function: "Processes visual information with circuits extending into other regions.", example: "Distinguishing edges and shapes before recognizing an object.", limit: "Vision is not a single operation. Recognition, attention and interpretation require more than the occipital cortex." } },
  { id: "cerebellum", view: "surface", color: "#978cb9", point: [459, 350], path: CEREBELLUM,
    es: { name: "Cerebelo", subtitle: "Afinar la coordinación", function: "Contribuye al equilibrio, la coordinación y el ajuste de movimientos.", example: "Ajustar un movimiento mientras una habilidad se vuelve más fluida con la práctica.", limit: "Su papel no se reduce a una etiqueta. Esta vista introductoria destaca funciones motoras y no representa toda la investigación cognitiva." },
    en: { name: "Cerebellum", subtitle: "Refining coordination", function: "Contributes to balance, coordination and the adjustment of movement.", example: "Adjusting a movement as a practiced skill becomes more fluent.", limit: "Its role cannot be reduced to a label. This introduction highlights motor functions, not the full scope of cognitive research." } },
  { id: "hippocampus", view: "internal", color: "#d49fbc", point: [346, 278], path: "M400 223 C416 236 412 255 396 271 C378 289 352 298 329 294 C313 292 299 300 292 309 C286 319 269 318 266 307 C260 291 273 276 292 274 C312 270 335 280 355 272 C378 264 395 249 389 236 C385 226 393 217 400 223 Z",
    es: { name: "Hipocampo", subtitle: "Formar nuevos recuerdos", function: "Es importante para formar recuerdos y para el aprendizaje espacial.", example: "Recordar dónde ocurrió una experiencia y relacionarla con su contexto.", limit: "Es una estructura interna. Aquí aparece en una proyección esquemática; no se ve en una vista exterior intacta ni equivale a toda la memoria." },
    en: { name: "Hippocampus", subtitle: "Forming new memories", function: "Important for forming memories and for spatial learning.", example: "Remembering where an experience happened and relating it to its context.", limit: "This is an internal structure shown in a schematic projection. It is not visible on an intact outer surface and is not the whole memory system." } },
  { id: "callosum", view: "internal", color: "#c6b7f3", point: [315, 170], path: "M223 218 C199 212 196 190 213 171 C239 141 303 133 355 144 C395 151 425 173 420 196 C416 213 397 220 384 208 C393 194 372 177 344 173 C299 165 255 174 238 191 C229 200 232 207 238 211 Z",
    es: { name: "Cuerpo calloso", subtitle: "Conectar hemisferios", function: "Es un gran conjunto de fibras que comunica los dos hemisferios cerebrales.", example: "Permitir el intercambio de información entre áreas de ambos lados del cerebro.", limit: "El grosor o la forma de una estructura no se traducen por sí solos en una medida de inteligencia. La imagen no representa tractografía real." },
    en: { name: "Corpus callosum", subtitle: "Connecting hemispheres", function: "A large bundle of fibers connecting the two cerebral hemispheres.", example: "Allowing information to pass between areas on both sides of the brain.", limit: "A structure’s thickness or shape is not, on its own, a measure of intelligence. This image is not real tractography." } },
];
    ...
    <div className="brain-explorer" ref={root}>
      ...
      <div className="brain-workspace">
        ...
        <article className="brain-detail" aria-live={playing ? "off" : "polite"}>
          ...
          <a href={region.view === "internal" ? "https://www.ninds.nih.gov/health-information/public-education/brain-basics/brain-basics-know-your-brain" : "https://www.nimh.nih.gov/news/media/2023/get-to-know-your-brain"} target="_blank" rel="noopener noreferrer">{text.source} · NIH <ArrowUpRight size={15} /></a>
        </article>
      </div>
